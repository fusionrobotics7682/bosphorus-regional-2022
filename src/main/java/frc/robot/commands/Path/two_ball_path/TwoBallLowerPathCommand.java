...
public class TwoBallLowerPathCommand extends CommandBase {
  ...
  public TwoBallLowerPathCommand(DriveSubsystem driveSubsystem) {
  ...
  @Override
  public void initialize() {  get1ballCommand =          
    new RamseteCommand(
    get1ballTrajectory,
