...
public class DriveBackwardXFeetCommand extends CommandBase {
 ...
 public DriveBackwardXFeetCommand(DriveSubsystem driveSubSystem, double feetSetpoint) {

     this.feetSetpoint = feetSetpoint;
     this.driveSubSystem = driveSubSystem;

     driveSubSystem.leftMotorGroup.setInverted(true);
     driveSubSystem.rightMotorGroup.setInverted(true);
