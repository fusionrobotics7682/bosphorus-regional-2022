...
public class UpperTwoBallCommand extends CommandBase {
  DriveSubsystem driveSubsystem;
  IntakeSubsystem intakeSubsystem;
  FeederSubsystem feederSubsystem;
  ShooterSubsystem shooterSubsystem;

  Command upperTwoBallCommand;

  /** Creates a new LowerTwoBallCommand. */
  public UpperTwoBallCommand(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem,FeederSubsystem feederSubsystem, ShooterSubsystem shooterSubsystem){
  ...
  public void initialize() {
    upperTwoBallCommand = new SequentialCommandGroup(
