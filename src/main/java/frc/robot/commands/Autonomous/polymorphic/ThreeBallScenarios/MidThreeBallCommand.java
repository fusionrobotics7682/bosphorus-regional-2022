...
package frc.robot.commands.Autonomous.polymorphic.ThreeBallScenarios;
...
import frc.robot.commands.Autonomous.unit.Drive.TimerBased.TurnLeftXsecond;
...
import frc.robot.commands.Autonomous.unit.Shooter.PID.ShootFromOutTarmacCommand;
import frc.robot.subsystems.DriveSubsystem;
import frc.robot.subsystems.FeederSubsystem;
import frc.robot.subsystems.IntakeSubsystem;
import frc.robot.subsystems.ShooterSubsystem;

public class MidThreeBallCommand extends CommandBase {
  DriveSubsystem driveSubsystem;
  IntakeSubsystem intakeSubsystem;
  FeederSubsystem feederSubsystem;
  ShooterSubsystem shooterSubsystem;

  Command midThreeBallCommand;

  /** Creates a new LowerTwoBallCommand. */
  public MidThreeBallCommand(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem,FeederSubsystem feederSubsystem, ShooterSubsystem shooterSubsystem){
  ...
  public void initialize() {
      ...
      new DriveStraightEncoderCommand(driveSubsystem, false, 16.839), new GetInTakeXSecond(intakeSubsystem, 5), 
      new DriveStraightEncoderCommand(driveSubsystem, true, 16.839), new TurnLeftXsecond(driveSubsystem, 1.5),
