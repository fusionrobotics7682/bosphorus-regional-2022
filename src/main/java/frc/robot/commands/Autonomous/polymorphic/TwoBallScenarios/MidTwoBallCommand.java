...
public class MidTwoBallCommand extends CommandBase {
  DriveSubsystem driveSubsystem;
  IntakeSubsystem intakeSubsystem;
  FeederSubsystem feederSubsystem;
  ShooterSubsystem shooterSubsystem;

  Command midTwoBallCommand;

  /** Creates a new LowerTwoBallCommand. */
  public MidTwoBallCommand(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem,FeederSubsystem feederSubsystem, ShooterSubsystem shooterSubsystem){
  ...
  public void initialize() {
    midTwoBallCommand = new SequentialCommandGroup(
      ...
      new ParallelCommandGroup(new DriveStraightEncoderCommand(driveSubsystem, true, 3.5170603675), new GetFeederXSecond(feederSubsystem, 1)), new TurnLeftXsecond(driveSubsystem, 1.5),
